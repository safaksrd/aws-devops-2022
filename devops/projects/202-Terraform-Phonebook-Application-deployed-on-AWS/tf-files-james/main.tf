...
resource "aws_launch_template" "asg-lt" {
  ...
  depends_on = [ null_resource.db-server-endpoint]
  tag_specifications {
...
resource "aws_db_instance" "db-server" {
  ...
  identifier                  = "phonebook-app-db-james"
  db_name                     = "phonebook"
  engine                      = "mysql"
...
resource "null_resource" "db-server-endpoint" {
