Ozet: 2020-09-16
  CloudFormation Template kullanarak olusturdugum Stack ile EC2 Instance da Kittens Carousel Static Website olusturuyorum. Bu Template Linux 2 ami kullanir ve 80 portundan HTTP baglantisina izin verir. Statik websayfasini GitHub repomdan cekiyorum.

  After preparing the YAML file, we go to the AWS Console. We create a stack from the Cloud Formation menu.
  
  CloudFormation Template for Kittens Carousel Static Website on EC2. This template deploys Kittens Carousel Static Website on Amazon Linux 2 (ami-0ed9277fb7eb570c9) EC2 Instance with custom security group allowing http connections on port 80. Kittens Carousel Static Website is downloaded from Github repository, then deployed on Apache Web Server.
