...
- Manuel olarak Target Group a Instance register etsek bile ASG algoritmasi bu Instance lari kale almaz ve kendi ALB kurallarina gore Instance uretir.
- Create Application Load Balancer
- Create Launch Template
- Create Auto Scaling Group
- Auto Scaling ALB nin onune koyacagiz. Instance acma ve kapamayi Auto Scaling ayarlayacak.
- ASG->Add Policy->Create Scaling Policy->Policy Type: Once Simple Scaling->CloudWatchAlarm icin ayarladigin alarmlari (Simple Artis ve Simple Azalis) sec-> Take the action ( 1 capacity Units, 200 seconds wait)

- Silme Sirasi : Target Tracking  Policy -> ASG -> ALB -> Target Group -> Cloud Watch Alarmlar
...
<body>
    ...
    <h3>This web server is launched from the launch template by SAFAK</h3>
...
- Not: Ortalama islemci yuku 1 dk boyunca %60 ustunde ise alarm calacak
