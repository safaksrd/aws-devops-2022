...
'SHOW TABLES; dersek herhangi bir table olmadigini goruruz.'
'offices table olusturuyoruz'
...
'offices table a alttaki bilgileri girecegiz'
...
'employees table a alttaki bilgileri girecegiz'
